package Cicindela::Recommender::SlopeOneDiffs;

# $Id: SlopeOneDiffs.pm 9 2008-12-23 20:53:55Z tsukue $
...
sub in_table { shift->{in_table} || 'slope_one_diffs_online' }
...
select item_id2 item_id, diff from %&in_table
  where item_id1 = ?
    and item_id2 != ?
...
sub recommend_for_user {
    ...
    my $limit = $opts->{limit} || $self->{limit} || 20;
